...
*A confirmar.* Candidato natural: PBI01 (estrutura inicial do projeto e persistência em arquivo), já que é pré-requisito de todos os outros.

## Tasks

*A definir/confirmar com a equipe.*
